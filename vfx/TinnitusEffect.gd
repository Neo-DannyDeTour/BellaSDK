...
func _ready() -> void:
	print("TinnitusEffect: _ready() called. Generating procedural ear ring for ", duration, " seconds.")
	...
	tween.tween_property(self, "volume_db", -60.0, duration).set_ease(Tween.EASE_IN_OUT).set_trans(Tween.TRANS_SINE)
