...
func _process(_delta: float) -> void:
	...
	var relative_transform: Transform3D = global_transform.affine_inverse() * player_camera.global_transform
...
func _teleport_body(body: Node3D) -> void:
	...
	if "velocity" in body:
		...
		body.set("velocity", (linked_portal.global_transform.basis * half_turn.basis) * relative_velocity)
