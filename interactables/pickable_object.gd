...
func _ready() -> void:
	...
	# NEW: Listen to the global Event Bus for vision assist toggle
	if Events.has_signal("vision_assist_toggled") and not Events.vision_assist_toggled.is_connected(_on_vision_assist_toggled):
