...
## Connects UI signals and interaction callbacks during normal gameplay.
func _ready() -> void:
...
## [param _button_name]: The string identifier of the pressed button (currently unused).
...
## Returns the mapped 2D coordinate on the UI viewport.
